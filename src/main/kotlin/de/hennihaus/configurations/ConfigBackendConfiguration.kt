...
data class ConfigBackendConfiguration(
    ...
    companion object {
        ...
        const val BANK_NAME = "grpc.application.bankName"
        const val CONFIG_BACKEND_PROTOCOL = "grpc.configBackend.protocol"
        const val CONFIG_BACKEND_HOST = "grpc.configBackend.host"
        const val CONFIG_BACKEND_PORT = "grpc.configBackend.port"
        const val CONFIG_BACKEND_RETRIES = "grpc.configBackend.retries"
    }
}
